...
`timescale 1 ns / 1 ps
	...
	module read_spi_v1_0_Write_to_RAM #
	(
	...
	assign M_AXI_ARADDR	= C_M_TARGET_SLAVE_BASE_ADDR + 32'h00000000;
	//Burst LENgth is number of transaction beats, minus 1
	...
	always @(*)begin
		case(state)
			t_36: axi_awvalid=1'b1;
		default   axi_awvalid=1'b0;
		endcase
	end
	...
	always @(*) begin
		case(state)
			t_36: axi_wvalid=1'b1;
			t_37: axi_wvalid=1'b1;
	...
	//araddr logic
	//assign axi_araddr = 32'h00000000;
